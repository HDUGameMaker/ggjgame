...
namespace OpenCVForUnity.BioinspiredModule
{
    ...
    public class Retina : Algorithm
    {
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor, float samplingStrength)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_10(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor, samplingStrength));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling, float reductionFactor)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_11(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling, reductionFactor));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod, bool useRetinaLogSampling)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_12(inputSize.width, inputSize.height, colorMode, colorSamplingMethod, useRetinaLogSampling));
        ...
        public static Retina create(Size inputSize, bool colorMode, int colorSamplingMethod)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_13(inputSize.width, inputSize.height, colorMode, colorSamplingMethod));
        ...
        public static Retina create(Size inputSize, bool colorMode)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_14(inputSize.width, inputSize.height, colorMode));
        ...
        public static Retina create(Size inputSize)
        {
            ...
            return Retina.__fromPtr__(bioinspired_Retina_create_15(inputSize.width, inputSize.height));
        ...
        // C++: static Ptr_Retina cv::bioinspired::Retina::create(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor = 1.0f, float samplingStrength = 10.0f)
        [DllImport(LIBNAME)]
        private static extern IntPtr bioinspired_Retina_create_10(double inputSize_width, double inputSize_height, [MarshalAs(UnmanagedType.U1)] bool colorMode, int colorSamplingMethod, [MarshalAs(UnmanagedType.U1)] bool useRetinaLogSampling, float reductionFactor, float samplingStrength);
        [DllImport(LIBNAME)]
