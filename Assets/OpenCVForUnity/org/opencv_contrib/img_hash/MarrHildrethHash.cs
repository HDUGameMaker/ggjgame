...
namespace OpenCVForUnity.Img_hashModule
{
    ...
    public class MarrHildrethHash : ImgHashBase
    {
        ...
        public static MarrHildrethHash create(float alpha, float scale)
        {
            ...
            return MarrHildrethHash.__fromPtr__(img_1hash_MarrHildrethHash_create_10(alpha, scale));
        ...
        public static MarrHildrethHash create(float alpha)
        {
            ...
            return MarrHildrethHash.__fromPtr__(img_1hash_MarrHildrethHash_create_11(alpha));
        ...
        public static MarrHildrethHash create()
        {
            ...
            return MarrHildrethHash.__fromPtr__(img_1hash_MarrHildrethHash_create_12());
