...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_10(_hessianThreshold, _nOctaves, _nOctaveLayers, _extended, _keypointsRatio, _upright));
...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_11(_hessianThreshold, _nOctaves, _nOctaveLayers, _extended, _keypointsRatio));
...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_12(_hessianThreshold, _nOctaves, _nOctaveLayers, _extended));
...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_13(_hessianThreshold, _nOctaves, _nOctaveLayers));
...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_14(_hessianThreshold, _nOctaves));
...
//            return SURF_CUDA.__fromPtr__(xfeatures2d_SURF_1CUDA_create_15(_hessianThreshold));
