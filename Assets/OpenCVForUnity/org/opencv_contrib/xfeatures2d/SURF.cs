...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_10(hessianThreshold, nOctaves, nOctaveLayers, extended, upright));
...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_11(hessianThreshold, nOctaves, nOctaveLayers, extended));
...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_12(hessianThreshold, nOctaves, nOctaveLayers));
...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_13(hessianThreshold, nOctaves));
...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_14(hessianThreshold));
...
//            return SURF.__fromPtr__(xfeatures2d_SURF_create_15());
