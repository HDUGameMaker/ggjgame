...
namespace OpenCVForUnity.ArucoModule
{
    ...
    public class Dictionary : DisposableOpenCVObject
    {
        ...
        public static Mat getBitsFromByteList(Mat byteList, int markerSize)
        {
            ...
            return new Mat(aruco_Dictionary_getBitsFromByteList_10(byteList.nativeObj, markerSize));
        ...
        public static Mat getByteListFromBits(Mat bits)
        {
            ...
            return new Mat(aruco_Dictionary_getByteListFromBits_10(bits.nativeObj));
        ...
        public static Dictionary create_from(int nMarkers, int markerSize, Dictionary baseDictionary, int randomSeed)
        {
            ...
            return Dictionary.__fromPtr__(aruco_Dictionary_create_1from_10(nMarkers, markerSize, baseDictionary.getNativeObjAddr(), randomSeed));
        ...
        public Mat get_bytesList()
        {
            ...
            return new Mat(aruco_Dictionary_get_1bytesList_10(nativeObj));
