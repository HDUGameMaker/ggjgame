...
namespace OpenCVForUnity.BgsegmModule
{
    ...
    public class Bgsegm
    {
        ...
        public static BackgroundSubtractorCNT createBackgroundSubtractorCNT(int minPixelStability, bool useHistory, int maxPixelStability, bool isParallel)
        {
            ...
            return BackgroundSubtractorCNT.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorCNT_10(minPixelStability, useHistory, maxPixelStability, isParallel));
        ...
        public static BackgroundSubtractorCNT createBackgroundSubtractorCNT(int minPixelStability, bool useHistory, int maxPixelStability)
        {
            ...
            return BackgroundSubtractorCNT.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorCNT_11(minPixelStability, useHistory, maxPixelStability));
        ...
        public static BackgroundSubtractorCNT createBackgroundSubtractorCNT(int minPixelStability, bool useHistory)
        {
            ...
            return BackgroundSubtractorCNT.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorCNT_12(minPixelStability, useHistory));
        ...
        public static BackgroundSubtractorCNT createBackgroundSubtractorCNT(int minPixelStability)
        {
            ...
            return BackgroundSubtractorCNT.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorCNT_13(minPixelStability));
        ...
        public static BackgroundSubtractorCNT createBackgroundSubtractorCNT()
        {
            ...
            return BackgroundSubtractorCNT.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorCNT_14());
        ...
        public static BackgroundSubtractorGMG createBackgroundSubtractorGMG(int initializationFrames, double decisionThreshold)
        {
            ...
            return BackgroundSubtractorGMG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGMG_10(initializationFrames, decisionThreshold));
        ...
        public static BackgroundSubtractorGMG createBackgroundSubtractorGMG(int initializationFrames)
        {
            ...
            return BackgroundSubtractorGMG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGMG_11(initializationFrames));
        ...
        public static BackgroundSubtractorGMG createBackgroundSubtractorGMG()
        {
            ...
            return BackgroundSubtractorGMG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGMG_12());
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha, float beta, float blinkingSupressionDecay, float blinkingSupressionMultiplier, float noiseRemovalThresholdFacBG, float noiseRemovalThresholdFacFG)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_10(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha, beta, blinkingSupressionDecay, blinkingSupressionMultiplier, noiseRemovalThresholdFacBG, noiseRemovalThresholdFacFG));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha, float beta, float blinkingSupressionDecay, float blinkingSupressionMultiplier, float noiseRemovalThresholdFacBG)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_11(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha, beta, blinkingSupressionDecay, blinkingSupressionMultiplier, noiseRemovalThresholdFacBG));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha, float beta, float blinkingSupressionDecay, float blinkingSupressionMultiplier)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_12(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha, beta, blinkingSupressionDecay, blinkingSupressionMultiplier));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha, float beta, float blinkingSupressionDecay)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_13(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha, beta, blinkingSupressionDecay));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha, float beta)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_14(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha, beta));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold, float alpha)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_15(mc, nSamples, replaceRate, propagationRate, hitsThreshold, alpha));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate, int hitsThreshold)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_16(mc, nSamples, replaceRate, propagationRate, hitsThreshold));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate, float propagationRate)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_17(mc, nSamples, replaceRate, propagationRate));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples, float replaceRate)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_18(mc, nSamples, replaceRate));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc, int nSamples)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_19(mc, nSamples));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC(int mc)
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_110(mc));
        ...
        public static BackgroundSubtractorGSOC createBackgroundSubtractorGSOC()
        {
            ...
            return BackgroundSubtractorGSOC.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorGSOC_111());
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec, float noiseRemovalThresholdFacBG, float noiseRemovalThresholdFacFG, int LSBPthreshold, int minCount)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_10(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale, Rincdec, noiseRemovalThresholdFacBG, noiseRemovalThresholdFacFG, LSBPthreshold, minCount));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec, float noiseRemovalThresholdFacBG, float noiseRemovalThresholdFacFG, int LSBPthreshold)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_11(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale, Rincdec, noiseRemovalThresholdFacBG, noiseRemovalThresholdFacFG, LSBPthreshold));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec, float noiseRemovalThresholdFacBG, float noiseRemovalThresholdFacFG)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_12(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale, Rincdec, noiseRemovalThresholdFacBG, noiseRemovalThresholdFacFG));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec, float noiseRemovalThresholdFacBG)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_13(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale, Rincdec, noiseRemovalThresholdFacBG));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale, float Rincdec)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_14(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale, Rincdec));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec, float Rscale)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_15(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec, Rscale));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc, float Tdec)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_16(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc, Tdec));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper, float Tinc)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_17(mc, nSamples, LSBPRadius, Tlower, Tupper, Tinc));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower, float Tupper)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_18(mc, nSamples, LSBPRadius, Tlower, Tupper));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius, float Tlower)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_19(mc, nSamples, LSBPRadius, Tlower));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples, int LSBPRadius)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_110(mc, nSamples, LSBPRadius));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc, int nSamples)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_111(mc, nSamples));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP(int mc)
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_112(mc));
        ...
        public static BackgroundSubtractorLSBP createBackgroundSubtractorLSBP()
        {
            ...
            return BackgroundSubtractorLSBP.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorLSBP_113());
        ...
        public static BackgroundSubtractorMOG createBackgroundSubtractorMOG(int history, int nmixtures, double backgroundRatio, double noiseSigma)
        {
            ...
            return BackgroundSubtractorMOG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorMOG_10(history, nmixtures, backgroundRatio, noiseSigma));
        ...
        public static BackgroundSubtractorMOG createBackgroundSubtractorMOG(int history, int nmixtures, double backgroundRatio)
        {
            ...
            return BackgroundSubtractorMOG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorMOG_11(history, nmixtures, backgroundRatio));
        ...
        public static BackgroundSubtractorMOG createBackgroundSubtractorMOG(int history, int nmixtures)
        {
            ...
            return BackgroundSubtractorMOG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorMOG_12(history, nmixtures));
        ...
        public static BackgroundSubtractorMOG createBackgroundSubtractorMOG(int history)
        {
            ...
            return BackgroundSubtractorMOG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorMOG_13(history));
        ...
        public static BackgroundSubtractorMOG createBackgroundSubtractorMOG()
        {
            ...
            return BackgroundSubtractorMOG.__fromPtr__(bgsegm_Bgsegm_createBackgroundSubtractorMOG_14());
        ...
        public static SyntheticSequenceGenerator createSyntheticSequenceGenerator(Mat background, Mat _object, double amplitude, double wavelength, double wavespeed, double objspeed)
        {
            ...
            return SyntheticSequenceGenerator.__fromPtr__(bgsegm_Bgsegm_createSyntheticSequenceGenerator_10(background.nativeObj, _object.nativeObj, amplitude, wavelength, wavespeed, objspeed));
        ...
        public static SyntheticSequenceGenerator createSyntheticSequenceGenerator(Mat background, Mat _object, double amplitude, double wavelength, double wavespeed)
        {
            ...
            return SyntheticSequenceGenerator.__fromPtr__(bgsegm_Bgsegm_createSyntheticSequenceGenerator_11(background.nativeObj, _object.nativeObj, amplitude, wavelength, wavespeed));
        ...
        public static SyntheticSequenceGenerator createSyntheticSequenceGenerator(Mat background, Mat _object, double amplitude, double wavelength)
        {
            ...
            return SyntheticSequenceGenerator.__fromPtr__(bgsegm_Bgsegm_createSyntheticSequenceGenerator_12(background.nativeObj, _object.nativeObj, amplitude, wavelength));
        ...
        public static SyntheticSequenceGenerator createSyntheticSequenceGenerator(Mat background, Mat _object, double amplitude)
        {
            ...
            return SyntheticSequenceGenerator.__fromPtr__(bgsegm_Bgsegm_createSyntheticSequenceGenerator_13(background.nativeObj, _object.nativeObj, amplitude));
        ...
        public static SyntheticSequenceGenerator createSyntheticSequenceGenerator(Mat background, Mat _object)
        {
            ...
            return SyntheticSequenceGenerator.__fromPtr__(bgsegm_Bgsegm_createSyntheticSequenceGenerator_14(background.nativeObj, _object.nativeObj));
