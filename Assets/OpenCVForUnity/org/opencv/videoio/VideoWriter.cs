...
namespace OpenCVForUnity.VideoioModule
{
    ...
    public class VideoWriter : DisposableOpenCVObject
    {
        ...
        public bool open(string filename, int apiPreference, int fourcc, double fps, Size frameSize, bool isColor)
        {
            ...
            return videoio_VideoWriter_open_10(nativeObj, filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height, isColor);
        ...
        public bool open(string filename, int apiPreference, int fourcc, double fps, Size frameSize)
        {
            ...
            return videoio_VideoWriter_open_11(nativeObj, filename, apiPreference, fourcc, fps, frameSize.width, frameSize.height);
        ...
        public bool open(string filename, int fourcc, double fps, Size frameSize, bool isColor)
        {
            ...
            return videoio_VideoWriter_open_12(nativeObj, filename, fourcc, fps, frameSize.width, frameSize.height, isColor);
        ...
        public bool open(string filename, int fourcc, double fps, Size frameSize)
        {
            ...
            return videoio_VideoWriter_open_13(nativeObj, filename, fourcc, fps, frameSize.width, frameSize.height);
