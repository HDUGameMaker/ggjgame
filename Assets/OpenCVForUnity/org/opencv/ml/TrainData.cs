...
namespace OpenCVForUnity.MlModule
{
    ...
    public class TrainData : DisposableOpenCVObject
    {
        ...
        public static Mat getSubMatrix(Mat matrix, Mat idx, int layout)
        {
            ...
            return new Mat(ml_TrainData_getSubMatrix_10(matrix.nativeObj, idx.nativeObj, layout));
        ...
        public Mat getTestSamples()
        {
            ...
            return new Mat(ml_TrainData_getTestSamples_10(nativeObj));
        ...
        public Mat getTrainSamples(int layout, bool compressSamples)
        {
            ...
            return new Mat(ml_TrainData_getTrainSamples_11(nativeObj, layout, compressSamples));
        ...
        public Mat getTrainSamples(int layout)
        {
            ...
            return new Mat(ml_TrainData_getTrainSamples_12(nativeObj, layout));
        ...
        public Mat getTrainSamples()
        {
            ...
            return new Mat(ml_TrainData_getTrainSamples_13(nativeObj));
        ...
        public Mat getVarSymbolFlags()
        {
            ...
            return new Mat(ml_TrainData_getVarSymbolFlags_10(nativeObj));
        ...
        public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx, Mat sampleWeights, Mat varType)
        {
            ...
            return TrainData.__fromPtr__(ml_TrainData_create_10(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj, sampleIdx.nativeObj, sampleWeights.nativeObj, varType.nativeObj));
        ...
        public static TrainData create(Mat samples, int layout, Mat responses, Mat varIdx, Mat sampleIdx)
        {
            ...
            return TrainData.__fromPtr__(ml_TrainData_create_12(samples.nativeObj, layout, responses.nativeObj, varIdx.nativeObj, sampleIdx.nativeObj));
