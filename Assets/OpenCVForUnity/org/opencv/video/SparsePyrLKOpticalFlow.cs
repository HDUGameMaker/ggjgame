...
namespace OpenCVForUnity.VideoModule
{
    ...
    public class SparsePyrLKOpticalFlow : SparseOpticalFlow
    {
        ...
        public static SparsePyrLKOpticalFlow create(Size winSize, int maxLevel, TermCriteria crit, int flags)
        {
            ...
            return SparsePyrLKOpticalFlow.__fromPtr__(video_SparsePyrLKOpticalFlow_create_11(winSize.width, winSize.height, maxLevel, crit.type, crit.maxCount, crit.epsilon, flags));
