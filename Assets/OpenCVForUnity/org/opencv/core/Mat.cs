 ...
 */
        ...
        public Mat(int[] sizes, int type)
        {
            ...
            nativeObj = core_Mat_n_1Mat__I_3II(sizes.Length, sizes, sizes.Length, type);
 ...
 */
        ...
        public Mat(int[] sizes, int type, Scalar s)
        {
            ...
            nativeObj = core_Mat_n_1Mat__I_3IIDDDD(sizes.Length, sizes, sizes.Length, type, s.val[0], s.val[1], s.val[2], s.val[3]);
 ...
 */
        ...
        public Mat(Mat m, Range[] ranges)
        {
            ...
            nativeObj = core_Mat_n_1Mat__J_3Lorg_opencv_core_Range_2(m.nativeObj, rangesArray, rangesArray.Length);
 ...
 */
        ...
        public static Mat ones(int[] sizes, int type)
        {
            ...
            return new Mat(core_Mat_n_1ones__I_3II(sizes.Length, sizes, sizes.Length, type));
 ...
 */
        ...
        public Mat reshape(int cn, int[] newshape)
        {
            ...
            return new Mat(core_Mat_n_1reshape_11(nativeObj, cn, newshape.Length, newshape, newshape.Length));
 ...
 */
        ...
        public Mat submat(Range[] ranges)
        {
            ...
            return new Mat(core_Mat_n_1submat_1ranges(nativeObj, rangesArray, rangesArray.Length));
 ...
 */
        ...
        public static Mat zeros(int[] sizes, int type)
        {
            ...
            return new Mat(core_Mat_n_1zeros__I_3II(sizes.Length, sizes, sizes.Length, type));
